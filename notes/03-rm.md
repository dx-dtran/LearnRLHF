...
Theory packet for Module 3 (Problems 3.1 through 3.5).

In Module 2 the model learned to imitate good-looking assistant replies. SFT
...
is better than answer B." Module 3 adds that ranking.
...
Module 4 (PPO) then uses this scalar score as a reward signal: the PPO
